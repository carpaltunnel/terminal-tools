...
11.  `broot` - [broot](https://github.com/Canop/broot) - TUI file system explorer with previews (similar to `yazi`)
12.  `yazi` - [yazi](https://github.com/sxyazi/yazi) - TUI file system explorer with previews (similar to `broot`)
